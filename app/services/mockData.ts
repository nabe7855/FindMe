...
export const mockStores: Store[] = [
  {
    ...
    reviews: [
      { id: 'r1-1', author: '田中', rating: 5, comment: '料理が本当に美味しい。特に旬の魚を使ったお造りは絶品でした。', date: '2023-10-26' },
      { id: 'r1-2', author: '鈴木', rating: 4, comment: '雰囲気が良く、デートに最適です。少し値段は張りますが価値はあります。', date: '2023-10-20' },
    ],
  },
  {
    id: '2',
    ...
    reviews: [
      { id: 'r2-1', author: '佐藤', rating: 4, comment: 'ピザがモチモチで最高！パスタも美味しかったです。', date: '2023-11-01' },
      { id: 'r2-2', author: '高橋', rating: 5, comment: '店員さんの対応が素晴らしく、気持ちよく食事ができました。', date: '2023-10-15' },
    ],
  },
  {
    id: '3',
    ...
    priceRange: '～￥1,000',
    reviews: [
      { id: 'r3-1', author: '渡辺', rating: 5, comment: 'これぞ博多ラーメン！スープまで飲み干してしまいました。', date: '2023-11-05' },
    ],
  },
  {
    id: '4',
    ...
    priceRange: '￥10,000～',
    reviews: [
       { id: 'r4-1', author: '伊藤', rating: 5, comment: 'カウンセリングが丁寧で、理想通りの髪型になりました！', date: '2023-10-28' },
    ],
  },
  {
    id: '5',
    ...
    area: '札幌市中央区',
    prefecture: '北海道',
    catch_phrase: '森の中にいるような癒やしの空間で、自家焙煎コーヒーを',
    rating: 4.6,
    reviewCount: 152,
    ...
    reviews: [
      { id: 'r5-1', author: '山田', rating: 5, comment: 'コーヒーが美味しいのはもちろん、チーズケーキが絶品です。', date: '2023-11-03' },
      { id: 'r5-2', author: '加藤', rating: 4, comment: '読書するのにぴったりの静かで落ち着いたカフェ。', date: '2023-10-18' },
    ],
  }
];
